...
from infomax import *
from model.tensor_gcn import Tensor_GGNN_GCN
...
class JavaEncoder(torch.nn.Module):
    def __init__(self, num_features, dim):
        ...
        self.conv = Tensor_GGNN_GCN(num_edge_types=4, out_features=dim, embedding_features=dim)
...
class Net(torch.nn.Module):
    ...
    def forward(self, data):
        ...
        # cos = torch.cosine_similarity(out1, out2, dim=1)
