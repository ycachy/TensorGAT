...
javaOfFiles = open(r'D:\Dataset\AtCoder\java-ast.txt', "r", encoding="utf-8")
javafilenameArray = javaOfFiles.readlines()
javaOfAst = open(r'D:\Dataset\AtCoder\java-ast.json', "r", encoding="utf-8")
javaastArray = javaOfAst.readlines()

cOfFiles = open(r'D:\Dataset\AtCoder\c-ast.txt', "r", encoding="utf-8")
cfilenameArray = cOfFiles.readlines()
cOfAst = open(r'D:\Dataset\AtCoder\c-ast.json', "r", encoding="utf-8")
castArray = cOfAst.readlines()

cppOfFiles = open(r'D:\Dataset\CodeNet\cpp-ast.txt', "r", encoding="utf-8")
cppfilenameArray = cppOfFiles.readlines()
cppOfAst = open(r'D:\Dataset\CodeNet\cpp-ast.json', "r", encoding="utf-8")
...
def test(loader):
    ...
    with open('last_epoch_roc_data.txt', 'w') as f:
        f.write('FPR,TPR\n')
...
if __name__ == '__main__':
    seed_everything()
    from TensorGATModel import Net
